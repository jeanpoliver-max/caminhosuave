...
import { Heart, Instagram, FacebookIcon } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/caminhosuave.org.br/" target="_blank" rel="noopener noreferrer" className="hover:text-[#8fd3c1] transition-colors"><Instagram className="h-5 w-5" /></a>
