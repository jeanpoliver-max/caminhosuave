            ...
            <div className="bg-primary text-white p-8 md:p-10 rounded-3xl shadow-lg relative overflow-hidden">
              ...
              <div className="mt-10 pt-8 border-t border-white/20">
                ...
                <div className="flex gap-4">
                  <a href="https://www.instagram.com/caminhosuave.org.br/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-secondary hover:text-primary transition-all"><Instagram className="w-5 h-5" /></a>
